  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text>Odometer</Text>
          <Text>{item?.odometer ? item?.odometer + "" : "Not Mentioned"}</Text>
        </Flex>
        <Flex
          justifyContent={"space-between"}
          alignItems={"center"}
        ...
        >
          ...
          <Text>
            {item?.original_paint ? item?.original_paint + "" : "Not Mentioned"}
          </Text>
        </Flex>
        <Flex
          justifyContent={"space-between"}
        ...
        >
          ...
          <Text>
            {item?.previous_buyer ? item?.previous_buyer + "" : "Not Mentioned"}
          </Text>
        </Flex>
        <Flex
          justifyContent={"space-between"}
